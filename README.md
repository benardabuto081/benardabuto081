...
`Machine Learning` `Data Science` `PyTorch` `Scikit-learn` `Pandas` `Geospatial Analysis`

**Software Engineering**

`Next.js` `NestJS` `PostgreSQL` `Redis` `REST APIs` `Git`

**Infrastructure**

`Docker` `Cloud` `CI/CD` `MLOps` `Linux`
...
| Project         | Area                | What it represents                                            |
| --------------- | ------------------- | ------------------------------------------------------------- |
| **Sauti Labs**  | AI Infrastructure   | Building AI foundations for African languages                 |
| **QueleaGuard** | ML Research         | Applying AI to agricultural and environmental intelligence    |
| **Rentra**      | Product Engineering | Building software infrastructure for African property markets |
